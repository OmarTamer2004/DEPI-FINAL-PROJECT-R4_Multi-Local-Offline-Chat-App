...
# ---------------- SESSION NAME ----------------
def generate_session_name(chain, question):
...
def main():
    ...
    if uploaded_audio:
        ...
        response = llm_chain.run(
            "Summarize this text: " + transcribed_audio
        )
    ...
    if voice_recording:
        ...
        response = llm_chain.run(transcribed_text)
    ...
    if send_button or st.session_state.send_input:
        ...
        if question != "":
            ...
            if (
                ...
                session_title = generate_session_name(
                    llm_chain,
                    question
                )
